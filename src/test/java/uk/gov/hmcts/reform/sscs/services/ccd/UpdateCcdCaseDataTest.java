...
public class UpdateCcdCaseDataTest {
    ...
    private final UpdateCcdCaseData updateCcdCaseData = new UpdateCcdCaseData();
    ...
    public void givenACaseUpdate_shouldNotOverwriteSubscriptions() throws Exception {
        ...
        updateCcdCaseData.updateCcdRecordForChangesAndReturnUpdateType(caseData, existingCaseDetails.getData());
    ...
    @Test
    public void shouldUpdateAppellantDetailsIfThereIsAChangeInGapsRecord() throws Exception {
        ...
        updateCcdCaseData.updateCcdRecordForChangesAndReturnUpdateType(caseData, sscsCaseDetails.getData());

...
public class TransformJsonCasesToCaseDataTest {
    ...
    public void givenJsonCases_shouldBeMappedIntoCaseData(String jsonCasesPath, String expectedCaseDataPath)
        throws IOException {
        // Given
        String jsonCases = FileUtils.getFileContentGivenFilePath(jsonCasesPath);
        ...
        String expectedCaseDataString = FileUtils.getFileContentGivenFilePath(expectedCaseDataPath);

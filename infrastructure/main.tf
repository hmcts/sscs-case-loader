...
locals {
  ...
  idamUrl = "${(var.env == "saat") ? "http://idam-api-idam-${local.local_env}.service.core-compute-idam-${local.local_env}.internal" : data.vault_generic_secret.idam_api.data["value"]}"
